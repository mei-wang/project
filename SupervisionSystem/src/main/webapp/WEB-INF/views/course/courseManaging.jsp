    ...
    $(document).ready(function () {
        oTable = $('#editable').DataTable({
            ...
            "aoColumns": [ //这个属性下的设置会应用到所有列，按顺序没有是空
                ...
                {
                    "mData": function (obj) {
                        var operate = '<a class="btn btn-primary" href="${pageContext.request.contextPath}/course/updateCoursePage?id='+obj.id+'"><i class="fa fa-edit">修改</i></a> | ' +'&nbsp;&nbsp;';
                        operate += '<button class="btn btn-danger" onclick="fnClickDeleteOne(this);" value="' + obj.id + '"><i class="fa fa-trash">删除</i> </button>';
                        return operate;
                    }
                }
            ],
