                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form:form class="form-horizontal" commandName="user" method="post"
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label">密码<font style="color: red">*</font> </label>
                                <div class="col-sm-4">
                                    <form:input path="passWord" id="passWord" class="form-control" onblur="this.value=this.value.trim()" />
                                </div>
                            </div>
